# Generated by Powerlevel10k configuration wizard on 2023-06-24 at 21:47 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_RUST_SHOW_ON_UPGLOB='*.rs|*.toml'
  ...
  typeset -g POWERLEVEL9K_ASDF_JAVA_SHOW_ON_UPGLOB='*.java|*.jar'
  ...
  typeset -g POWERLEVEL9K_ASDF_POSTGRES_SHOW_ON_UPGLOB='*.sql|*.psql'
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(gpd|wg|(.*tun)|tailscale|proton)[0-9]*|(zt.*)'
